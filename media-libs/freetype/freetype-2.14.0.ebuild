...
SRC_URI="https://download.savannah.gnu.org/releases/freetype/freetype-2.14.0.tar.xz -> freetype-2.14.0.tar.xz
	utils?	( https://download.savannah.gnu.org/releases/freetype/ft2demos-2.14.0.tar.xz -> ft2demos-2.14.0.tar.xz )
	doc?	( https://download.savannah.gnu.org/releases/freetype/freetype-doc-2.14.0.tar.xz -> freetype-doc-2.14.0.tar.xz )
"
KEYWORDS="*"
