...
SRC_URI="https://github.com/KhronosGroup/Vulkan-Loader/tarball/6c7b2db415f07e6c6489c596144693602ecece07 -> Vulkan-Loader-1.3.235-6c7b2db.tar.gz"
...
DEPEND="
	=dev-util/vulkan-headers-1.3.235*
	${PYTHON_DEPS}
...
"
PDEPEND="layers? ( =media-libs/vulkan-layers-1.3.234*:= )"
